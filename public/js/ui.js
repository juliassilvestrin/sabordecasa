...
import { renderResultsList, renderResultDetail, renderNoSubstitute, renderRecipeResults } from './results.js';
...
const sections = {
  ...
  'recipe-results': document.getElementById('recipe-results-section'),
};
...
subscribe((state) => {
  ...
  switch (state.currentView) {
    ...
    case 'recipe-results': {
      renderRecipeResults(document.getElementById('recipe-results-content'), state.recipeResults);
      searchButton.disabled = false;
      searchButton.textContent = t('searchBtn');
      break;
    }
